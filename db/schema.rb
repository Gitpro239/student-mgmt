...
ActiveRecord::Schema[8.0].define(version: 2025_02_26_063835) do
  ...
  create_table "cources_students", id: false, force: :cascade do |t|
    ...
    t.index ["cource_id", "student_id"], name: "index_cources_students_on_cource_id_and_student_id"
    t.index ["student_id", "cource_id"], name: "index_cources_students_on_student_id_and_cource_id"
  end
